...
<p align="center">
  <a href="https://x.com/Krishan02482510"><img src="https://img.shields.io/twitter/follow/KrishanuRoy_07?logo=twitter&style=for-the-badge&color=1DA1F2" /></a>
</p>
...
- 📫 Reach me at **roykrishanu366@gmail.com**
...
**Languages**
`Python` `Java` `C#` `C/C++` `SQL` `PL/SQL` `JavaScript` `HTML` `CSS` `Bash`

**Developer Tools**
`Git` `GitHub` `Jupyter` `Visual Studio` `VS Code` `Postman` `Linux`

**Backend & APIs**
`.NET Core` `ASP.NET MVC` `Django` `Flask` `REST APIs` `Entity Framework` `Stored Procedures`

**Databases**
`SQL Server` `MySQL` `MongoDB` `Redis` `Amazon RDS` `DynamoDB`

**Cloud (AWS)**
`EC2` `S3` `RDS` `DynamoDB` `SageMaker` `Bedrock` `QuickSight` `IAM`

**Data & Distributed Systems**
`Pandas` `NumPy` `Scikit-learn` `TensorFlow` `Apache Kafka` `Apache Spark` `Hadoop`

**AI/ML Algorithms**
`XGBoost` `Random Forest` `Decision Tree` `Logistic Regression` `SVM` `KNN` `K-Means` `Isolation Forest` `ANN` `LSTM` `Autoencoder` `GNN / GCN / GAT` `GraphSAGE` `SHAP` `LIME` `PCA` `AdaBoost` `Gradient Boosting`

**Domain Expertise**
`FinTech` `UPI` `Digital Payments` `Prepaid Cards` `KYC` `Payment Processing` `RBI Reporting`
...
<p align="left">
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/csharp/csharp-original.svg" width="32" height="32"/>
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/postman/postman-original.svg" width="32" height="32"/>
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/microsoftsqlserver/microsoftsqlserver-plain.svg" width="32" height="32"/>
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/redis/redis-original.svg" width="32" height="32"/>
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/amazonwebservices/amazonwebservices-original-wordmark.svg" width="32" height="32"/>
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/apachekafka/apachekafka-original.svg" width="32" height="32"/>
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/apachespark/apachespark-original.svg" width="32" height="32"/>
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/hadoop/hadoop-original.svg" width="32" height="32"/>
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/2ae2a900d2f041da66e950e4d48052658d850630/icons/pandas/pandas-original.svg" width="32" height="32"/>
